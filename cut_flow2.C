...
void print(const char *name, const char *fname, const char *title, int chanel)
{
	...
	for(Long64_t event = 0; event < eventNr; event++)
	{
		...
		if(cnt1 > 0) {
			CNT1 += weight1 * weight2;
		}
		if(cnt2 > 0) {
			CNT2 += weight1 * weight2;
		}
		if(cnt3 > 0) {
		...
		if(cnt7 > 0) {
			CNT7 += weight1 * weight2;
		}
		if(cnt8_eeuu > 0) {
			CNT8_eeuu += weight1 * weight2;
		}
		if(cnt8_uuee > 0) {
			CNT8_uuee += weight1 * weight2;
		}
		if(cnt9_eeuu > 0) {
			CNT9_eeuu += weight1 * weight2;
		}
		if(cnt9_uuee > 0) {
			CNT9_uuee += weight1 * weight2;
		}
		if(cnt10_eeuu > 0) {
			CNT10_eeuu += weight1 * weight2;
		}
		if(cnt10_uuee > 0) {
			CNT10_uuee += weight1 * weight2;
		}
	}
